...
focl as 
(
select _id , lane_source , lane_destination  ,vehicle_type_display_name ,city, number_of_bids , vehicles_required ,  number_of_bids / vehicles_required as bids_per_veh_reqd, distance  
from field_ops_client_listing focl 
where bid_flag = true  and vehicles_required > 0 
),
fob_city as 
(
...
focl_partners as 
(
select vehicle_type_display_name  , lane_source , lane_destination  , count(partner_id) as lc_partners 
...
select focl.* , fob_city.city_partners, fob_city.city_unique_vehicles, fob_bid.bid_case_city_partners ,  fob_bid.bid_case_city_unique_vehicles, focl_partners.lc_partners, fob.revenue, fob.cost, fob.margin  from focl focl left join fob_city fob_city 
